...
import 'package:fafte/ui/widget/message_container/default_message_decoration.dart';
...
class TextContainer extends StatelessWidget {
  ...
  final Widget Function(MessageModel, MessageModel?, MessageModel?)?
      messageTextBuilder;
    ...
    return Container(
        decoration: messageOptions.messageDecorationBuilder != null
            ...
            : defaultMessageDecoration(
                ...
                borderTopLeft: isPreviousSameAuthor &&
                        !isOwnMessage &&
                        !isAfterDateSeparator
                    ? 0.0
                    : 18.0,
                borderTopRight: isPreviousSameAuthor &&
                        isOwnMessage &&
                        !isAfterDateSeparator
                    ? 0.0
                    : 18.0,
